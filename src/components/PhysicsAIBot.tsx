...
export function PhysicsAIBot({ subject, chapter, level, isOpen, onClose }: PhysicsAIBotProps) {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const initialGreetings = {
        beginner: `Hi! I'm your Physics tutor for ${chapter}. I'll give you simple, easy explanations perfect for beginners! What would you like to learn? 🔬`,
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const placeholderResponses = {
        beginner: `I'm your Physics tutor for ${chapter}. I'll give you simple, easy explanations perfect for beginners! 🔬`,
      ...
      const errorMessage: Message = {
        id: (Date.now() + 1).toString(),
        role: 'assistant',
        content: `Physics chatbot is coming soon! Stay tuned for AI-powered physics tutoring. 🔬`,
        timestamp: new Date()
      };
      ...
      <CardHeader className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-4 rounded-t-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-lg font-semibold">Physics AI Assistant</h2>
          </div>
          <Button
            variant="ghost"
            size="sm"
              ...
              <div className="flex justify-start">
                <div className="bg-gray-100 rounded-lg px-4 py-3 text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Physics AI is thinking...</span>
                  </div>
                </div>
              </div>
            )}
